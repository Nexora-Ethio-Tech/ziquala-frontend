...
export const monasteryDonation = {
  ...
  schoolBankName: 'Dashen Bank',
  schoolAccountNumber: '5819907149011',
} as const;

export const monasteryDocumentContent = {
  overview: 'ከአዲስ አበባ በስተደቡብ 84 ኪሎ ሜትር፣ እንዲሁም ከቢሾፍቱ (ደብረ ዘይት) ከተማ 40 ኪ.ሜ ርቀት ላይ የሚገኘው የዝቋላ ደብረ ከዋክብት አቡነ ገብረ መንፈስ ቅዱስ አንድነት ገዳም፣ ከባህር ወለል በላይ 2989 ሜትር ከፍታ ላይ የተቀመጠ ታላቅ መንፈሳዊ ስፍራ ነው። ገዳሙ “ደብረ ከዋክብት” የተባለበት ዋና ምክንያት፣ በስፍራው የሚገኙት አባቶችና መናንያን እንደ ከዋክብት እያበሩ ሌሊቱን ሙሉ በጸሎት ስለሚያሳልፉ ነው።',
  spiritualLife: 'ገዳሙ የንባብ፣ የቅዳሴ፣ የቅኔ፣ የዜማ እና የመጻሕፍት ትርጓሜ ትምህርት ቤቶችን የያዘ የትምህርት፣ የመናንያን ሕይወት እና የልማት ማዕከል ነው። ከ300 በላይ አባቶች እና 160 የሚደርሱ እናቶች በብሕትውና፣ በግብርና፣ በሸማ ሥራ እና በጸሎት ይኖሩበታል።',
  conclusion: 'የዝቋላ ደብረ ከዋክብት አቡነ ገብረ መንፈስ ቅዱስ አንድነት ገዳም የኢትዮጵያውያን የጸሎት ዋሻ፣ የስውራን አባቶች ማደሪያ እና የኦርቶዶክስ ተዋሕዶ ቤተ ክርስቲያን የቅድስና ዓምድ ነው።',
} as const;

export const monasteryDevelopmentProjects = [
  { title: 'የዘይት ፋብሪካ', body: 'በአዱላላ ከተማ የተቋቋመው የዘይት ፋብሪካ ለገዳሙም ሆነ ለአካባቢው ማኅበረሰብ ጠቃሚ የኢኮኖሚ ምንጭ ሆኗል።' },
  { title: 'የትምህርት ቤት ተቋም', body: 'በቢሾፍቱ (ደብረ ዘይት) ከተማ የተቋቋመው ትምህርት ቤት ማኅበራዊ ኃላፊነትን በመወጣት ትውልድን በዕውቀት ለማነጽ ያገለግላል።' },
  { title: 'የእህል ወፍጮ ቤት', body: 'በገዳሙ ውስጥ የሚገኘው የእህል ወፍጮ ቤት ለገዳሙ እና ለአካባቢው ነዋሪዎች የዕለት ተዕለት አገልግሎት ይሰጣል።' },
  { title: 'የእጅ ጥበብ እና ሸማ ሥራ', body: 'መናንያኑ አልባሳትን፣ ሸማዎችን እና የተለያዩ የእጅ ጥበብ ውጤቶችን በማምረት ለገዳሙ ተጨማሪ ገቢ ያስገኛሉ።' },
  { title: 'የግብርና እና የእንስሳት እርባታ', body: 'በውስን የእርሻ እና የእርባታ ቦታ ላይ በመሥራት ገዳሙን በምግብ ራሱን ለማስቻል ይጥራል።' },
] as const;
...
export const annualCelebrations = [
  { title: 'የመጋቢት 5 የአቡነ ገብረ መንፈስ ቅዱስ ዓመታዊ ንግሥ', body: 'የጻድቁ አባት የዕረፍታቸው መታሰቢያ እና የቃል ኪዳን ቀን።' },
  { title: 'የየካቲት 16 ኪዳነ ምሕረት', body: 'ለእመቤታችን ድንግል ማርያም የሚደረግ የበዓል መታሰቢያ።' },
  { title: 'የነሐሴ 16 ፍልሰታ ማርያም', body: 'የእመቤታችን ሥጋ ወደ ሰማይ ያረገበት ታላቅ መታሰቢያ በዓል።' },
] as const;
